...
from consumer import auth_sec_deliver, log_deliver, downloader_deliver, update_deliver
...
def update():
    try:
        ...
        downloader_deliver(is_authorized)
        update_deliver(is_authorized)
    except:
...
if __name__ == '__main__':
    ...
    config.update(config_parser['auth_sec'])
